...
//função para procurar o valor requerido.
//Ela Divide o vetor ao meio e caso o valor requerido se encontre 
//no meio, ela Retorna a posição do vetor onde o valor procurado se encontra
//Caso o valor seja maior que o valor do meio, a metade esquerda é descartada.
//Caso o valor seja menor que o valor do meio, a metade direita é descartada.
//Caso a valor não se encontra, retorna -1
  funcao inteiro BinarySearch(inteiro valor,inteiro comeco,inteiro final){
  inteiro meio
...
//função principal
  funcao inicio() {
   inteiro valor,receberRetorno,comeco=0,final=tam-1
  ...
  escreva("\n")
   ...
   receberRetorno=BinarySearch(valor,comeco,final)
   se(receberRetorno==-1){
